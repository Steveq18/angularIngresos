...
export class FrmIngresosComponent {
  @Input() ingresoParaEditar:Ingresos|null = null;

  @Output() ingresoAgregado = new EventEmitter<Ingresos>();
  @Output() editame = new EventEmitter<Ingresos>();



  ingresos:Ingresos[]=[];

  nuevoingreso:Ingresos={id:"",nombre:"",fecha:"",monto:0};
